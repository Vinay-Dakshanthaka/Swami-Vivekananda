...
?>
    ...
    <section aria-label="newest photos" class="imagesSection
    ">
        <div class="carousel" data-carousel>
            ...
            <ul data-slides>
                <li class="slide" data-active>
                    <img src="../images/swami-1.jpg" alt="" width="618" height="314">
                </li>
                <li class="slide" data-active>
                    <img src="../images/swami-2.png" alt="" width="618" height="314">
                </li>
                <li class="slide" data-active>
                    <img src="../images/swami-3.jpg" alt="" width="618" height="314">
                </li>
                <!-- <li class="slide" data-active>
                    <img src="../images/swami-4.jpg"  alt="" width="618" height="314">
                </li> -->
                <li class="slide" data-active>
                    <img src="../images/swami-5.webp" alt="" width="618" height="314">
                </li>
                <li class="slide" data-active>
                    <img src="../images/swami-6.webp" alt="" width="618" height="314">
                </li>
                <li class="slide" data-active>
                    <img src="../images/swami-7.jpg" alt="" width="618" height="314">
                </li>
            </ul>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <p>
                Swami Vivekananda  Bengali: [ʃami bibekanɔndo] (listen); 12 January 1863  4 July 1902), born Narendranath Datta (Bengali: [nɔrendronatʰ dɔto]), was an Indian Hindu monk, philosopher, author, religious teacher, and the chief disciple of the Indian mystic Ramakrishna.
